                                    ...
                                    <div class="profile-about-me">
                                        ...
                                        <div class="row mb-2">
                                            <div class="col-sm-3 col-5">
                                                <h2>
                                                    <a
                                                        href="https://www.instagram.com/{{ auth()->user()->profile->instagram }}/"><i
                                            ...
                                            <form action="edit-profile" method="POST" enctype="multipart/form-data">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="mb-3 col-md-6">
                                                        ...
                                                        <img class="avatar-lg rounded-circle img-thumbnail"
                                                            src="{{ url('/' . auth()->user()->profile->foto) }}"
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <textarea name="alamat" id="" cols="30" rows="5" class="form-control">{{ auth()->user()->profile->alamat }}</textarea>
                                                </div>
