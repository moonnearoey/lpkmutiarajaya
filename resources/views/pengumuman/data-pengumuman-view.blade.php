                    ...
                    <div class="d-flex align-items-center justify-content-between flex-wrap">
                        ...
                        <div class="mb-3">
                            <div class="d-flex align-items-center mb-4 pb-3 justify-content-end flex-wrap">
                                ...
                                <div class="me-3">
                                    <img src="{{ asset('sipenmaru/images/logoroblox.png') }}" alt=""
                                        width="50px">
                                </div>
                                <!--
                                            <div>
                            ...
                            <table class="table mb-0">
                                ...
                                <tbody border="5">
                                    ...
                                    <tr border="5">
                                        ...
                                        <td colspan="4"><img src="{{ url('/' . $viewIdPendaftaran->pas_foto) }}"
                                                alt="" width="180px" height="240"></td>
                                    <tr>
                                            ...
                                            @foreach ($viewData as $x)
                                                ...
                                                @elseif ($x->hasil_seleksi == 'LULUS' && $x->id_pendaftaran == $viewIdPendaftaran->id)
                                                    ...
                                                    <div class="alert alert-outline-success alert-dismissible fade show"
                                                        ...
                                                        <table>
                                                            <tr>
                                                                <th scope="row">Kursus Penerima
                                                                    <b>{{ $x->kursus->nama_kursus }}</b></th>
                                                            </tr>
                                    ...
                                    <tr>
                                        <td scope="row" style="margin-top:-50px"><small>* Simpan bukti pengumuman ini
                                                sebagai salah satu bukti telah melakukan pendaftaran</small></td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
