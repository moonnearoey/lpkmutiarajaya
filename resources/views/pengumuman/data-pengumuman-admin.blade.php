                                                    ...
                                                    <div class="row">
                                                        <div class="col-xl-6">
                                                            ...
                                                            <input type="number" class="form-control"
                                                                placeholder="Masukkan Nilai Rata Rata" name="interview"
                                                                required>
                                                        </div>
                                                        <div class="col-xl-6">
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($viewData as $x)
                                            <tr>
                                                <td>{{ $no++ }}</td>
                                                <td><a
                                                        href="detail-registration/{{ $x->pendaftaran->id_pendaftaran }}">{{ $x->pendaftaran->id_pendaftaran }}</a>
                                                </td>
                                                <td><a
                                                        href="detail-registration/{{ $x->pendaftaran->id_pendaftaran }}">{{ $x->pendaftaran->nama_siswa }}</a>
                                                </td>
                                                <td>
                            ...
                            <div class="modal fade edit{{ $x->id_pengumuman }}" tabindex="-1" role="dialog"
                                ...
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form action="update-announcement/{{ $x->id_pengumuman }}" method="POST"
                                                ...
                                                <div class="form-group">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-xl-6">
                                                            <label for="iduser">Hasil</label>
                                                            <select class="default-select form-control wide" title="Result"
                                                                name="hasil" required>
                                                                <option value="{{ $x->hasil_seleksi }}" selected>
                                                                    {{ $x->hasil_seleksi }}</option>
                                                                <option value="LULUS">LULUS</option>
                                                                <option value="TIDAK LULUS">TIDAK LULUS</option>
                                                            </select>
                                                        </div>
                                                ...
                                                <div class="form-group">
                                                    <label for="iduser">Kursus Penerima </label>
                                                    <select class="default-select form-control wide" title="Recipient"
                                                        name="kursus" required>
                                                        @if ($x->hasil_seleksi == 'LULUS' || $x->hasil_seleksi == 'Lulus' || $x->hasil_seleksi == 'lulus')
                                                            <option value="{{ $x->kursus_penerima }}" selected>
                                                                {{ $x->kursus->nama_kursus }}</option>
                                                        @endif
                                                        <option value="{{ $x->pendaftaran->pil1 }}">Pilihan 1 :
                                                            {{ $x->pendaftaran->pilihan1->nama_kursus }}</option>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-xl-6">
                                                            ...
                                                            <input type="number" class="form-control" id="nama"
                                                                value="{{ $x->nilai_interview }}" name="interview" required>
                                                        </div>
                                                        <div class="col-xl-6">
                                                            <label for="iduser">Nilai Tes</label>
                                                            <input type="number" class="form-control" id="nama"
                                                                value="{{ $x->nilai_test }}" name="test" required>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="modal-footer border-top-0 d-flex">
