...
<div class="row page-titles" style="border-radius: 0%">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="javascript:void(0)">LPK "Mutiara Jaya"</a></li>
    </ol>
</div>
<div class="row">
    <div class="col-xl-7">
                ...
                <div id="carouselExampleIndicators2" class="carousel slide" data-bs-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img class="d-block w-100" src="{{ asset('sipenmaru/images/7.jpg') }}" alt="First slide">
                        </div>
                        <div class="carousel-item">
                            <img class="d-block w-100" src="{{ asset('sipenmaru/images/8.jpg') }}" alt="Second slide">
                        </div>
                        <div class="carousel-item">
                            <img class="d-block w-100" src="{{ asset('sipenmaru/images/9.jpg') }}" alt="Third slide">
                        </div>
                        <div class="carousel-item">
                            <img class="d-block w-100" src="{{ asset('sipenmaru/images/10.jpg') }}" alt="Fourth slide">
                        </div>
                        <div class="carousel-item">
                            <img class="d-block w-100" src="{{ asset('sipenmaru/images/11.jpg') }}" alt="Fifth slide">
                        </div>
                        <div class="carousel-item">
                            <img class="d-block w-100" src="{{ asset('sipenmaru/images/12.jpg') }}" alt="Sixth slide">
                        </div>
                        <div class="carousel-item">
                            <img class="d-block w-100" src="{{ asset('sipenmaru/images/13.jpg') }}" alt="Seventh slide">
                        </div>
                        <div class="carousel-item">
                            <img class="d-block w-100" src="{{ asset('sipenmaru/images/14.jpg') }}" alt="Eighth slide">
                        </div>
                        <div class="carousel-item">
                            <img class="d-block w-100" src="{{ asset('sipenmaru/images/15.jpg') }}" alt="Nineth slide">
                        </div>
                    </div>
                    ...
                    <div class="card-body p-4">
                        <div class="media">
                            ...
                            <div class="media-body text-white">
                                ...
                                <h3 class="text-white">295</h3>
                                <div class="progress mb-1 bg-primary">
            ...
            <div class="card" style="border-radius: 0%;">
                <div class="new-arrival-product">
                    <div class="new-arrivals-img-contnent">
                        <img class="img-fluid" src="{{ asset('sipenmaru/images/baliho.jpg') }}" alt="">
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-md-7">
                                ...
                                <p>: {{ $x->hari }}</p>
                                <p>: {{ $x->harga_kursus }}</p>
                                <p>: <a href="{{ $x->contoh_game }}" target="_blank">Link demo
                                        {{ $x->nama_kursus }}</a> </p>
                            </div>
                        </div>
                            ...
                            <div class="col-xl-3 col-lg-6  col-md-6 col-xxl-5 ">
                                ...
                                <div class="tab-content">
                                    <div role="tabpanel" class="tab-pane fade show active" id="first">
                                        <img class="img-fluid" src="{{ asset('sipenmaru/images/brosur.jpg') }}"
                                            alt="">
                                    </div>
                                    <div role="tabpanel" class="tab-pane fade" id="second">
                                        <img class="img-fluid" src="{{ asset('sipenmaru/images/ceo.jpg') }}"
                                            alt="">
                                    </div>
                                    <div role="tabpanel" class="tab-pane fade" id="third">
                                        <img class="img-fluid" src="{{ asset('sipenmaru/images/founder.jpg') }}"
                                            alt="">
                                    </div>
                                    <div role="tabpanel" class="tab-pane fade" id="four">
                                        <img class="img-fluid" src="{{ asset('sipenmaru/images/features.jpg') }}"
                                            alt="">
                                    </div>
                                </div>
                                    ...
                                    <ul class="nav slide-item-list mt-3" role="tablist">
                                        <li role="presentation" class="show">
                                            <a href="#first" role="tab" data-bs-toggle="tab">
                                                <img class="img-fluid"
                                                    src="{{ asset('sipenmaru/images/brosur.jpg') }}" alt=""
                                                    width="50">
                                            </a>
                                        </li>
                                        <li role="presentation">
                                            <a href="#second" role="tab" data-bs-toggle="tab"><img
                                                    class="img-fluid" src="{{ asset('sipenmaru/images/ceo.jpg') }}"
                                                    alt="" width="50"></a>
                                        </li>
                                        <li role="presentation">
                                            <a href="#third" role="tab" data-bs-toggle="tab"><img
                                                    class="img-fluid"
                                                    src="{{ asset('sipenmaru/images/founder.jpg') }}" alt=""
                                                    width="50"></a>
                                        </li>
                                        <li role="presentation">
                                            <a href="#four" role="tab" data-bs-toggle="tab"><img
                                                    class="img-fluid"
                                                    src="{{ asset('sipenmaru/images/features.jpg') }}" alt=""
                                                    width="50"></a>
                                        </li>
                                    </ul>
                                </div>
                                    ...
                                    <div class="new-arrival-content pr">
                                        ...
                                        <div class="custom-tab-1">
                                            ...
                                            <ul class="list-inline">
                                                <li class="list-inline-item">1. Siswa/ Siswi SMP/SMA/SMK/MA/Sederajat
                                                </li><br>
                                                <li class="list-inline-item">2. Mengisi data pendaftaran</li><br>
                                                <li class="list-inline-item">3. Melampirkan Surat Slip Gaji Orangtua
                                                    (Optional)</li><br>
                                                <li class="list-inline-item">4. Melampirkan pas photo 3×4 atau 4×6 (@ 1
                                                    lembar)</li><br>
                                                <li class="list-inline-item">5. Melampirkan fotokopi dokumen Raport,
                                                    Ijazah <small>(Jika ada), Sertifikat Prestasi <small>(Jika
                                                            ada)</small></li><br>
                                            </ul>
                                        </div>
                                        <h4 class="text-primary mb-4">Biaya Pendaftaran :</h4>
                                        <ul class="list-inline">
                                            <li class="list-inline-item">*BANK BRI : 598101013303537 a.n Maryoso
                                                (Administrator)</li><br>
                                            <li class="list-inline-item">*BANK BRI : 598101018905538 a.n Misbahul Munir
                                                (Administrator)</li><br>
                                    </div>
                                </div>
                            </div>
