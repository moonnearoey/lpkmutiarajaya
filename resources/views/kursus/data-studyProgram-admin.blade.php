                            ...
                            <tbody>
                                @foreach ($viewData as $x)
                                    <tr>
                                        ...
                                        <td>{{ $x->id_kursus }}</td>
                                        <td><a href="{{ $x->contoh_game }}" target="_blank"> {{ $x->nama_kursus }}</a>
                                        </td>
                                        <td>{{ $x->harga_kursus }}</td>
                                        <td>{{ $x->pengajar }}</td>
                                        <td>{{ $x->hari }}/ {{ $x->jam }}</td>
                                        <td><img src="{{ asset($x->foto_kursus) }}" width="200px" height="200"
                                                alt=""></td>
                                        <td>
                                            <div class="d-flex">
                                                    ...
                                                    <form action="update-kursus/{{ $x->id }}" method="POST"
                                                        ...
                                                        <div class="form-group">
                                                            <input type="hidden" name="id" id="nama"
                                                                class="form-control" value="{{ $x->id }}">
                                                            <div class="row">
                                                                <div class="col-xl-12">
                                                                    <label for="iduser">Nama Kursus</label>
                                                                    <input type="text" class="form-control"
                                                                        id="nama" value="{{ $x->nama_kursus }}"
                                                                ...
                                                                <div class="col-xl-12">
                                                                    ...
                                                                    <input type="text" class="form-control"
                                                                        id="jenjang" value="{{ $x->jenjang_kursus }}"
                                                                ...
                                                                <div class="col-xl-12">
                                                                    ...
                                                                    <input type="text" class="form-control"
                                                                        id="jam" value="{{ $x->jam }}"
                                                                        placeholder="Masukan Jam" name="jam" required>
                                                                </div>
                                                                <div class="col-xl-12">
                                                                    <label for="iduser">Hari</label>
                                                                    <input type="text" class="form-control"
                                                                        id="hari" value="{{ $x->hari }}"
                                                                ...
                                                                <div class="form-group">
                                                                    <label for="iduser">Biaya Pendaftaran</label>
                                                                    <input type="text" class="form-control"
                                                                        id="harga_kursus" value="{{ $x->harga_kursus }}"
                                                                        placeholder="Masukkan biaya kursus"
                                                                        name="harga_kursus" required>
                                                                </div>
                                                                <div class="col-xl-12">
                                                                    <label for="iduser">Link Demo Game</label>
                                                                    <input type="text" class="form-control"
                                                                        id="contoh_game" value="{{ $x->contoh_game }}"
                                                                        placeholder="Masukan Link Demo Game"
                                                                        name="contoh_game" required>
                                                                </div>
                                                                <div class="col-xl-12">
                                                                    <label for="iduser">Foto Kursus</label>
                                                                    <div class="input-group">
