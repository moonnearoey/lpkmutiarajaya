                            ...
                            <div class="col-lg-6">
                                <center>
                                    <h4 class="form-label" style="margin-top: -0.5rem"><strong class="d-block">KARTU
                                            PESERTA</strong></h4>
                                    <h4 style="margin-top: -0.5rem"> <strong class="d-block">PENERIMAAN PESERTA KURSUS
                                            BARU</strong></h4>
                                    <h3 style="margin-top: -0.5rem"><strong class="d-block">PROGRAMMING COURSE
                                            ROBLOX</strong></h3>
                                    <p style="margin-top: -0.5rem"><strong class="d-block">Jln. Sariasih IV, No.54, Kota
                                            Bandung, Jawa Barat, 40151, Indonesia<br></strong></p>
                                </center>
                            </div>
                        </div>
                    </div>
                    <div class="card-body" style="margin-bottom: -4rem;">
                        ...
                        <div class="mb-4">
                            ...
                            <h5 style="text-indent: 0.5in;text-align: justify;">Saya yang menyatakan bahwa data yang
                                saya isikan dalam formulir pendaftaran penerimaan peserta kursus baru Programming Course
                                Roblox tahun 2023 adalah benar dan saya bersedia menerima ketentuan yang berlaku. Saya
