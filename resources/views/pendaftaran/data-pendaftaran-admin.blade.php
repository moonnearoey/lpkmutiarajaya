                            ...
                            <td>
                                <div class="d-flex">
                                    ...
                                    <a class="btn btn-danger shadow btn-xs sharp"><i class="fa fa-trash"
                                            data-bs-toggle="modal" data-bs-target=".delete{{ $x->id_pendaftaran }}"></i></a>
                                    <div class="modal fade delete{{ $x->id_pendaftaran }}" tabindex="-1" role="dialog"
                                        aria-hidden="true">
                                        <div class="modal-dialog modal-sm">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <a href="delete-registration/{{ $x->id }}">
    ...
    @elseif(auth()->user()->role == 'Calon Peserta')
        <div class="project-page d-flex justify-content-between align-items-center flex-wrap">
            <div class="project mb-4">
                <ul class="nav nav-tabs" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" data-bs-toggle="tab" href="#AllStatus" role="tab">Semua
                            Pendaftaran</a>
                    </li>
                    <li class="nav-item">
                                            ...
                                            <div class="row align-items-center">
                                                ...
                                                <div class="col-xl-3  col-lg-6 col-sm-6 mb-sm-4 mb-0">
                                                    <div class="d-flex project-image">
                                                        ...
                                                        <div>
                                                            <small class="d-block fs-16 font-w400">{{ $x->gelombang }}</small>
        ...
        @if ($no == 0)
            <div class="alert alert-primary alert-dismissible alert-alt fade show">
                ...
                <strong>Haii!</strong> Kamu belum melakukan pendaftaran silahkan daftar dan ikuti proses kegiatannya setelahnya.
            </div>
        @endif
        @endif
    @endauth
