                                        ...
                                        <div class="mb-3 mb-4">
                                            ...
                                            @if (auth()->user()->profile->nama != null)
                                                <input type="text" class="form-control" id="basicpill" name="nama"
                                                    ...
                                                    value="{{ auth()->user()->profile->nama }}" required>
                                            @else
                                        ...
                                        <div class="mb-3 mb-4">
                                            ...
                                            @if (auth()->user()->profile->no_hp != null)
                                                <input type="number" class="form-control" id="basicpill" name="nohp"
                                                    ...
                                                    value="{{ auth()->user()->profile->no_hp }}" required>
                                            @else
                                                <input type="number" class="form-control" id="basicpill" name="nohp"
                                    ...
                                    <div class="col-lg-6">
                                        <div class="mb-3 mb-4">
                                            <label class="form-label" for="personal-data-nisn">Pilihan
                                                1</label>
                                            <select name="pil1" id="" class="form-control">
                                    ...
                                    <div class="col-lg-2">
                                        <div class="mb-3 mb-4">
                                            ...
                                            <input type="number" class="form-control" name="smt1"
                                                placeholder="Masukkan Rata Nilai Semester" value="{{ old('smt1') }}"
                                                required>
                                            @error('smt1')
                                                <div class="alert alert-warning" role="alert">
                                                    <strong>Peringatan!</strong>
                                    ...
                                    <div class="col-lg-2">
                                        <div class="mb-3 mb-4">
                                            ...
                                            <input type="number" class="form-control" name="smt2"
                                                placeholder="Masukkan Rata Nilai Semester" value="{{ old('smt2') }}"
                                                required>
                                            @error('smt2')
                                                <div class="alert alert-warning" role="alert">
                                                    <strong>Peringatan!</strong>
                                    ...
                                    <div class="col-lg-2">
                                        <div class="mb-3 mb-4">
                                            ...
                                            <input type="number" class="form-control" name="smt3"
                                                placeholder="Masukkan Rata Nilai Semester" value="{{ old('smt3') }}"
                                                required>
                                            @error('smt3')
                                                <div class="alert alert-warning" role="alert">
                                                    <strong>Peringatan!</strong>
                                    ...
                                    <div class="col-lg-2">
                                        <div class="mb-3 mb-4">
                                            ...
                                            <input type="number" class="form-control" name="smt4"
                                                placeholder="Masukkan Rata Nilai Semester" value="{{ old('smt4') }}"
                                                required>
                                            @error('smt4')
                                                <div class="alert alert-warning" role="alert">
                                                    <strong>Peringatan!</strong>
                                    ...
                                    <div class="col-lg-2">
                                        <div class="mb-3 mb-4">
                                            ...
                                            <input type="number" class="form-control" name="smt5"
                                                placeholder="Masukkan Rata Nilai Semester" value="{{ old('smt5') }}"
                                                required>
                                            @error('smt5')
                                                <div class="alert alert-warning" role="alert">
                                                    <strong>Peringatan!</strong>
