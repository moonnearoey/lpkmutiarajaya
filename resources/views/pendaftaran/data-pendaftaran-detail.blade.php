                        ...
                        <div class="col">
                            <div class="text-end mt-2 mt-sm-0">
                                ...
                                @if ($viewData->status_pendaftaran == 'Belum Terverifikasi')
                                    <a href="../../verified-registration/{{ $viewData->id_pendaftaran }}"><button
                                            type="button" class="btn btn-primary">Verified</button></a>
                                @endif
                                <a href="../../card-registration/{{ $viewData->id }}"><button type="button"
                            ...
                            <div class="row mb-3">
                                <div class="col-sm-12 col-12">
                                    ...
                                    <div class="col-sm-9 col-7">
                                        <a href="{{ asset($viewData->berkas_siswa) }}"> <i class="fa fa-file-pdf"
