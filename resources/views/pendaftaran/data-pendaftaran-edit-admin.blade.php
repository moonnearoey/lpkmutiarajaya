                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="mb-3 mb-4">
                                            ...
                                            <input type="text" value="{{ $viewData->nisn }}" class="form-control"
                                                id="personal-data-nisn" name="nisn" placeholder="Enter NISN"
                                                value="{{ old('nisn') }}">
                                            @error('nisn')
                                    ...
                                    <div class="col-lg-6">
                                        <div class="mb-3 mb-4">
                                            ...
                                            <input type="text" value="{{ $viewData->nik }}" class="form-control"
                                                id="personal-data-nik" name="nik" placeholder="Enter NIK"
                                                value="{{ old('nik') }}">
                                            @error('nik')
                                                <div class="alert alert-warning" role="alert">
                                                    <strong>Peringatan!</strong>
                                ...
                                <div class="row">
                                    <div class="col-lg-4">
                                        <div class="mb-3 mb-4">
                                            ...
                                            <input type="text" value="{{ $viewData->nama_siswa }}" class="form-control"
                                                id="personal-data-name" name="nama" placeholder="Enter Name"
                                                value="{{ old('nama') }}">
                                            @error('nama')
                                                <div class="alert alert-warning" role="alert">
                                                    <strong>Peringatan!</strong>
                                        ...
                                        <div class="mb-3 mb-4">
                                            ...
                                            @if ($viewData->jenis_kelamin == 'Perempuan')
                                                <select class="form-control wide" name="jk"
                                                    value="{{ old('jk') }}">
                                                    <option value="{{ $viewData->jenis_kelamin }}" selected>
                                                        {{ $viewData->jenis_kelamin }}</option>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="mb-4 mb-lg-0">
                                            ...
                                            <input type="text" value="{{ $viewData->tempat_lahir }}"
                                                class="form-control" id="basicpill" name="tempatlahir"
                                    ...
                                    <div class="col-lg-4">
                                        <div class="mb-4 mb-lg-0">
                                            ...
                                            <input type="date" value="{{ $viewData->tanggal_lahir }}"
                                                class="form-control" id="basicpill" name="tanggallahir"
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="mb-3 mb-4">
                                            ...
                                            <input type="email" value="{{ $viewData->email }}" class="form-control"
                                                id="personal-data-nisn" name="email" placeholder="Masukkan email"
                                                value="{{ old('email') }}">
                                            @error('email')
                                                <div class="alert alert-warning" role="alert">
                                                    <strong>Peringatan!</strong>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="mb-3 mb-4">
                                            ...
                                            <input type="number" value="{{ $viewData->hp }}" class="form-control"
                                                id="personal-data-nik" name="nohp" placeholder="Masukkan No HP"
                                                value="{{ old('nohp') }}">
                                            @error('nohp')
                                                <div class="alert alert-warning" role="alert">
                                                    <strong>Peringatan!</strong>
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="mb-3 mb-4">
                                            ...
                                            <input class="form-control" value="{{ $viewData->pil1 }}"
                                                list="datalistOptionskursus" id="exampleDataList"
                                                placeholder="Cari Kursus..." name="pil1" value="{{ old('pil1') }}"
                                                autocomplete='off'>
                                ...
                                <div class="row">
                                    <div class="col-lg-4">
                                        <div class="mb-3 mb-4">
                                            ...
                                            <input type="text" value="{{ $viewData->nama_ayah }}"
                                                class="form-control" id="personal-data-name" name="ayah"
                                    ...
                                    <div class="col-lg-4">
                                        <div class="mb-3 mb-4">
                                            ...
                                            <input class="form-control" value="{{ $viewData->pekerjaan_ayah }}"
                                                list="datalistOptionsOccupation" id="exampleDataList"
                                                placeholder="Cari Pekerjaan..." name="pekerjaanayah"
                                    ...
                                    <div class="col-lg-4">
                                        <div class="mb-3 mb-4">
                                            ...
                                            <input type="number" value="{{ $viewData->nohp_ayah }}"
                                                class="form-control" id="personal-data-no" name="noayah"
                                ...
                                <div class="row">
                                    <div class="col-lg-4">
                                        <div class="mb-3 mb-4">
                                            ...
                                            <input type="text" value="{{ $viewData->nama_ibu }}" class="form-control"
                                                id="personal-data-name" name="ibu" placeholder="Nama Ibu"
                                                value="{{ old('ibu') }}" autocomplete="off">
                                            @error('ibu')
                                                <div class="alert alert-warning" role="alert">
                                                    <strong>Peringatan!</strong>
                                                    {{ $message }}
                                    ...
                                    <div class="col-lg-4">
                                        <div class="mb-3 mb-4">
                                            ...
                                            <input class="form-control" value="{{ $viewData->pekerjaan_ibu }}"
                                                list="datalistOptionsOccupation" id="exampleDataList"
                                                placeholder="Cari Pekerjaan..." name="pekerjaanibu"
                                    ...
                                    <div class="col-lg-4">
                                        <div class="mb-3 mb-4">
                                            ...
                                            <input type="number" value="{{ $viewData->nohp_ibu }}" class="form-control"
                                                id="personal-data-no" name="noibu" placeholder="Telepon Ibu"
                                                value="{{ old('noibu') }}">
                                            @error('noibu')
                                                <div class="alert alert-warning" role="alert">
                                                    <strong>Peringatan!</strong>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="mb-3 mb-4">
                                            ...
                                            <select class="form-control wide" title="Recipient" name="penghasilan_ayah"
                                                required>
                                                <option value="{{ $viewData->penghasilan_ayah }}" selected>
                                                    {{ $viewData->penghasilan_ayah }}</option>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="mb-3 mb-4">
                                            ...
                                            <select class="form-control wide" title="Recipient" name="penghasilan_ibu"
                                                required>
                                                <option value="{{ $viewData->penghasilan_ibu }}" selected>
                                                    {{ $viewData->penghasilan_ibu }}</option>
                                                <option value="< 1.0000.000">
                                                    < 1.000.000</option>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="mb-3 mb-4">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <div class="form-file">
                                                    <input type="file" class="form-file-input form-control"
                                                        name="ftberkas_ortu" value="{{ old('ftberkas_ortu') }}">
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="mb-3 mb-4">
                                            ...
                                            <input class="form-control" value="{{ $viewData->sekolah }}"
                                                list="datalistOptionsSekolah" id="exampleDataList"
                                                placeholder="Cari NPSN sekolah...." name="sekolah"
                                                value="{{ old('sekolah') }}">
                                ...
                                <div class="row">
                                    <div class="col-lg-2">
                                        <div class="mb-3 mb-4">
                                            ...
                                            <input type="number" value="{{ $viewData->smt1 }}" class="form-control"
                                                name="smt1" placeholder="Masukkan nilai rata-rata"
                                                value="{{ old('smt1') }}">
                                            @error('smt1')
                                                <div class="alert alert-warning" role="alert">
                                                    <strong>Peringatan!</strong>
                                    ...
                                    <div class="col-lg-2">
                                        <div class="mb-3 mb-4">
                                            ...
                                            <input type="number" value="{{ $viewData->smt2 }}" class="form-control"
                                                name="smt2" placeholder="Masukkan nilai rata-rata"
                                                value="{{ old('smt2') }}">
                                            @error('smt2')
                                                <div class="alert alert-warning" role="alert">
                                                    <strong>Peringatan!</strong>
                                    ...
                                    <div class="col-lg-2">
                                        <div class="mb-3 mb-4">
                                            ...
                                            <input type="number" value="{{ $viewData->smt3 }}" class="form-control"
                                                name="smt3" placeholder="Masukkan nilai rata-rata"
                                                value="{{ old('smt3') }}">
                                            @error('smt3')
                                                <div class="alert alert-warning" role="alert">
                                                    <strong>Peringatan!</strong>
                                    ...
                                    <div class="col-lg-2">
                                        <div class="mb-3 mb-4">
                                            ...
                                            <input type="number" value="{{ $viewData->smt4 }}" class="form-control"
                                                name="smt4" placeholder="Masukkan nilai rata-rata"
                                                value="{{ old('smt4') }}">
                                            @error('smt4')
                                                <div class="alert alert-warning" role="alert">
                                                    <strong>Peringatan!</strong>
                                    ...
                                    <div class="col-lg-2">
                                        <div class="mb-3 mb-4">
                                            ...
                                            <input type="number" value="{{ $viewData->smt5 }}" class="form-control"
                                                name="smt5" placeholder="Masukkan nilai rata-rata"
                                                value="{{ old('smt5') }}">
                                            @error('smt5')
                                                <div class="alert alert-warning" role="alert">
                                                    <strong>Peringatan!</strong>
                                    ...
                                    <div class="col-lg-2">
                                        <div class="mb-3 mb-4">
                                            ...
                                            <input type="number" value="{{ $viewData->smt6 }}" class="form-control"
                                                name="smt6" placeholder="Masukkan nilai rata-rata"
                                                value="{{ old('smt6') }}">
                                            @error('smt6')
                                                <div class="alert alert-warning" role="alert">
                                                    <strong>Peringatan!</strong>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="mb-3 mb-4">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <div class="form-file">
                                                    <input type="file" class="form-file-input form-control"
                                                        name="ftberkas_siswa" value="{{ old('ftberkas_siswa') }}">
