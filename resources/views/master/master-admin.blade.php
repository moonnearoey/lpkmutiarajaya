...
<head>
    ...
    <!-- FAVICONS ICON -->
    <link rel="shortcut icon" type="image/png" href="{{ asset('sipenmaru/images/favicon.ico') }}">
        ...
        ***********************************-->
        <div class="nav-header">
            <a href="dashboard" class="brand-logo">
                <img alt="image" width="25" src="{{ asset('sipenmaru/images/LPKMJ.png') }}">
                <div class="brand-title">
                    <h3 class=""><strong>MUTIARA JAYA</strong></h3>
                </div>
            </a>
        ...
        ***********************************-->
        ...
        <div class="dlabnav">
            ...
            <div class="dlabnav-scroll">
                ...
                <div class="copyright">
                    <p><strong>LEMBAGA PELATIHAN KERJA</strong> ©
                        <script>
                            document.write(new Date().getFullYear())
                        </script> All Rights Reserved
                    </p>
                    <p class="fs-12">Made with <span class="fa fa-heart"></span> by LPK "Mutiara Jaya"</p>
                </div>
            </div>
        </div>
        <!--**********************************
        ...
        <div class="footer">
            <div class="copyright">
                <p>Copyright ©
                    ...
                    Designed &amp; Developed by <a href="https://www.instagram.com/lpkmutiarajaya/"
                        target="_blank">LPK
                        "Mutiara Jaya"</a> | Repost by <a href="https://www.instagram.com/msbahulmnr/"
                        title='@msbahulmnr' target='_blank'>@msbahulmnr</a>
