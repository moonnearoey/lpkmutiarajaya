                                                    ...
                                                    <div class="dropdown text-sans-serif"><button
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-end border py-0"
                                                            ...
                                                            <div class="py-2"><a class="dropdown-item"
                                                                    ...
                                                                    class="dropdown-item"
                                                                    href="/unpaid-payment/{{ $x->id_pembayaran }}">Belum
                                                                    Bayar</a>
                                                                <div class="dropdown-divider"></div><a
                                                                    class="dropdown-item text-danger"
                                                                    href="/invalid-payment/{{ $x->id_pembayaran }}">Tidak
                                                                    Sah</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="modal-dialog modal-sm">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body text-center"><i
                                                                ...
                                                                menghapus data ini?<br>{{ $x->id_pembayaran }}
                                                            </div>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-xl-4">
                                                                    ...
                                                                    <select class="form-control wide"
                                                                        title="id pendaftaran" name="id_pendaftaran"
                                                                        required>
                                                                        <option value="{{ $x->id_pendaftaran }}" selected>
                                                                            {{ $x->pendaftaran->id_pendaftaran }} ||
                                                                            {{ $x->pendaftaran->nama_siswa }}</option>
                                                                    </select>
                                                                </div>
                                                                <div class="col-xl-8">
                                                                    <label for="iduser">Status</label>
